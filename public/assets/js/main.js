...
/* 2. sticky And Scroll UP */
    $(window).on('scroll', function () {
      ...
      if (scroll < 400) {
        $(".header-sticky").removeclassName("sticky-bar");
        $('#back-top').fadeOut(500);
      } else {
        $(".header-sticky").addclassName("sticky-bar");
        $('#back-top').fadeIn(500);
      }
    });
...
testimonial.slick({
    ...
    loop:true,
    arrows: true,
    prevArrow: '<button type="button" className="slick-prev"><i className="ti-arrow-top-left"></i></button>',
    nextArrow: '<button type="button" className="slick-next"><i className="ti-arrow-top-right"></i></button>',
    slidesToShow: 1,
    slidesToScroll: 1,
    responsive: [
      {
