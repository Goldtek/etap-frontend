    ...
    IonRangeSlider.prototype = {
        ...
        append: function () {
            ...
            if (this.options.disable) {
                ...
                this.$cache.cont.removeclassName("irs-disabled");
        ...
        setTopHandler: function () {
            ...
            if (from > min && to === max) {
                this.$cache.s_from.addclassName("type_last");
            } else if (to < max) {
                this.$cache.s_to.addclassName("type_last");
            }
        },
        ...
        changeLevel: function (target) {
            switch (target) {
                ...
                case "from":
                    ...
                    this.$cache.s_from.addclassName("state_hover");
                    this.$cache.s_from.addclassName("type_last");
                    this.$cache.s_to.removeclassName("type_last");
                    break;
                case "to":
                    this.coords.p_gap = this.toFixed(this.coords.p_pointer - this.coords.p_to_fake);
                    this.$cache.s_to.addclassName("state_hover");
                    this.$cache.s_to.addclassName("type_last");
                    this.$cache.s_from.removeclassName("type_last");
                    break;
                case "both":
        ...
        appendDisableMask: function () {
            ...
            this.$cache.cont.addclassName("irs-disabled");
        },
        ...
        pointerUp: function (e) {
            ...
            this.$cache.cont.find(".state_hover").removeclassName("state_hover");
        ...
        toggleInput: function () {
            this.$cache.input.toggleclassName("irs-hidden-input");
        },
        ...
        appendGrid: function () {
            ...
            this.$cache.cont.addclassName("irs-with-grid");
